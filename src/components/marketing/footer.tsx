            ...
            <Container>
                <Wrapper className="pt-10 flex items-center justify-between relative">
                    <p className="text-sm text-secondary-foreground">
                        &copy; {new Date().getFullYear()} Paypulse. All rights reserved.
                    </p>
                    <div className="flex items-center gap-4">
                        ...
                        <Link href="https://github.com/ombaviskar18/Paypulse" className="p-1 text-sm text-muted-foreground hover:text-secondary-foreground">
                            GitHub
                        </Link>
                    </div>
                </Wrapper>
